...
void dac_Board_Timer_IRQ(){
	...
	if (dacTick < AD5644_CHANNEL_COUNT) ad5644_Write_Dma(dacTick); // 0 to 15
	else if (dacTick == AD5644_CHANNEL_COUNT) mcp23017_Tx_GpioA_Buffer_Dma(); // 16
	else if (dacTick == (AD5644_CHANNEL_COUNT+1)) mcp23017_Tx_GpioB_Buffer_Dma(); // 17
